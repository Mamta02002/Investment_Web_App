...
def predict():
    if request.method == 'POST':
        ...
        model = pickle.load('ven_model.pkl',encoding='latin1')
...
def predict1():
    if request.method == 'POST':
        ...
        data = request.form
        #return the extracted information
        model = pickle.load('st_model.pkl',encoding='latin1')
        ohe = pickle.load('ohe_market.pkl',encoding='lating1')
        le = pickle.load('le_status.pkl',encoding='latin1')
